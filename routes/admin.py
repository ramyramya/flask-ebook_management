...
def book_add():
    ...
    if request.method == 'POST':
        ...
        # Call the add function of BookManager to add the book
        book_details = {'name': title, 'count': qty, 'availability': available, 'description': description, 'author': author, 'edition': edition}
        book_manager.add(book_details)
...
def book_edit(id):
    ...
    if request.method == 'GET':
        ...
        # Render the edit form with the book details
        ...
        author = request.form.get('author')
        edition = request.form.get('edition')
        count = request.form.get('qty')
        availability = request.form.get('available')
        description = request.form.get('description')

        # Update the book details in the database
        updated_book = book_manager.updateBook(id, name, author, edition, count, availability, description)

        # Redirect to the book details page or any other appropriate page
        return redirect('/admin/books')  # Redirect to the book listing page
